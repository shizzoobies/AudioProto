...
const BUILD_ID = '20260610-1 cs-demo-ui';
...
// ============================================================================
// Customer Service demo — Meridian intranet "Customer Management" tool
// ----------------------------------------------------------------------------
...
// (caller "Greg Foster"). Four views live inside one .cs-tool container and are
// switched purely by toggling [data-cs-view] panels — no re-render of the call.
