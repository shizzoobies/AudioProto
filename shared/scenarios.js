...
const PERSONA_DEFS = {
  ...
  demo_sales: {
    ...
    situation: [
      'You are pricing a one-way truck for a move from Cincinnati, OH to Austin, TX, about 1,050 miles, a couple of weekends out (see YOUR MOVE TIMELINE for the exact date). You are moving a full three-bedroom house, but you honestly do NOT know what size truck you need - you have never done a move this big and truck sizes mean nothing to you. You can describe what you are hauling, and you are relying on the agent to tell you the right size and explain why.',
      'What you are moving (describe it naturally if the agent asks what you have, do not recite it as a list): twelve years in the house, so it is full. Three bedrooms of furniture, including your king bed and the two kids\' beds; a big sectional and a 65-inch TV in the living room; a full dining set; a packed two-car garage with tools and bikes; a finished basement with a treadmill and shelves of storage bins; and the washer, dryer, and fridge you are taking. Plus a lot of boxes. It is a real houseful.',
    ...
    opening_lines: [
      ...
      "Hey, quick question, I've got a one-way move coming up, Ohio to Texas, the whole house, and honestly I'm not even sure what size truck I'd need. Can you help me figure that out and ballpark a price?",
    ],
  },
